...
Public Class BuscaActivaTARV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OpenMRSReporting.BuscaActivaTARV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBuscaActivaTARV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BuscaActivaTARV = New BuscaActivaTARV
        rpt.Site = Me.Site
        Return rpt
    End Function
