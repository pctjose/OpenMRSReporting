...
Public Class tstneewstructure
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OpenMRSReporting.tstneewstructure.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtstneewstructure
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As tstneewstructure = New tstneewstructure
        rpt.Site = Me.Site
        Return rpt
    End Function
