...
Public Class rptTransferencia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OpenMRSReporting.rptTransferencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptTransferencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransferencia = New rptTransferencia
        rpt.Site = Me.Site
        Return rpt
    End Function
