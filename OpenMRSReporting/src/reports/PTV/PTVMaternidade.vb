...
Public Class PTVMaternidade
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OpenMRSReporting.PTVMaternidade.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPTVMaternidade
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PTVMaternidade = New PTVMaternidade
        rpt.Site = Me.Site
        Return rpt
    End Function
