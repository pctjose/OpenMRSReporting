...
Public Class RelatorioMensaNovo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OpenMRSReporting.RelatorioMensaNovo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRelatorioMensaNovo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatorioMensaNovo = New RelatorioMensaNovo
        rpt.Site = Me.Site
        Return rpt
    End Function
