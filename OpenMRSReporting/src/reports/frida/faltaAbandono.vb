...
Public Class faltaAbandono
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OpenMRSReporting.faltaAbandono.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_abandono() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedfaltaAbandono
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As faltaAbandono = New faltaAbandono
        rpt.Site = Me.Site
        Return rpt
    End Function
