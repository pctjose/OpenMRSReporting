...
Public Class DuploInicioTarv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OpenMRSReporting.DuploInicioTarv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDuploInicioTarv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DuploInicioTarv = New DuploInicioTarv
        rpt.Site = Me.Site
        Return rpt
    End Function
