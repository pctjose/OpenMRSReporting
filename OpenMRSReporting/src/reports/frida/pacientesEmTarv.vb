...
Public Class pacientesEmTarv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OpenMRSReporting.pacientesEmTarv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpacientesEmTarv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As pacientesEmTarv = New pacientesEmTarv
        rpt.Site = Me.Site
        Return rpt
    End Function
