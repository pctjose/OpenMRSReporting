...
Public Class IndicadorSemanalNovoLands
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "IndicadorSemanalNovoLands.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OpenMRSReporting.IndicadorSemanalNovoLands.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_reportID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedIndicadorSemanalNovoLands
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IndicadorSemanalNovoLands = New IndicadorSemanalNovoLands
        rpt.Site = Me.Site
        Return rpt
    End Function
