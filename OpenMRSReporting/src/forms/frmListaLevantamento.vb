Public Class frmListaLevantamento
    ...
    Private Sub frmListaLevantamento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
        ...
        Try
            ...
            If Not (Me.txtNID.Text = Nothing) Then
                ...
                If patientID = 0 Or patientID = Nothing Then
                    ...
                    Exit Sub
                End If
                rpt.SetParameterValue(rpt.Parameter_openmrsid.ParameterFieldName, patientID)
            Else
                rpt.SetParameterValue(rpt.Parameter_openmrsid.ParameterFieldName, 0)
            End If

            
            rpt.SetParameterValue(rpt.Parameter_location_id.ParameterFieldName, Me.cboUS.SelectedValue)
            rpt.SetParameterValue(rpt.Parameter_dataInicial.ParameterFieldName, Me.dataInicial.Value.Date)
            rpt.SetParameterValue(rpt.Parameter_dataFinal.ParameterFieldName, Me.dataFinal.Value.Date)
            ...
            If Me.rdDetalhado.Checked Then
                ...
                rpt.SetParameterValue(rpt.Parameter_Titulo.ParameterFieldName, "HISTORICO DE ACOMPANHAMENTO DE TRATAMENTO ARV DE PACIENTES")
            Else
                rpt.SetParameterValue(rpt.Parameter_Tipo.ParameterFieldName, 1)
                rpt.SetParameterValue(rpt.Parameter_Titulo.ParameterFieldName, "ULTIMO LEVANTAMENTO DE ARV'S DE PACIENTES")
            End If
            forma.rptViewer.ReportSource = rpt
            forma.Text = "HISTORICO FRIDA"
